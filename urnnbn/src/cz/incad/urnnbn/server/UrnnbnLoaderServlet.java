    ...
    private Form createDigitalniReprezentaceForm(){
        ...
        /*.addChild(new RefButton(struct.digitalniReprezentace.INTELEKTUALNI_ENTITA, intelektualniEntitaArr,
            ...
            .addChild(new HorizontalPanel()
                ...
                .addChild(new TextField(struct.digitalniReprezentace.FINANCOVANO).setWidth("20em"))
                .addChild(new TextField(struct.digitalniReprezentace.CISLO_ZAKAZKY).setWidth("20em"))
            ).addChild(new HorizontalPanel()
                .addChild(new TextField(struct.digitalniReprezentace.DOSTUPNOST).setWidth("20em"))
                .addChild(new TextField(struct.digitalniReprezentace.BAREVNOST).setWidth("20em"))
                .addChild(new TextField(struct.digitalniReprezentace.FORMAT).setWidth("20em"))
            ).addChild(new HorizontalPanel()
                .addChild(new TextField(struct.digitalniReprezentace.ROZLISENI).setWidth("20em"))
                .addChild(new TextField(struct.digitalniReprezentace.ROZSAH).setWidth("20em"))
            ).addChild(new HorizontalPanel()
