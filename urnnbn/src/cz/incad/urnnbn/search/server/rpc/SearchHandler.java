...
public class SearchHandler implements CommandHandler<Search, SearchResponse> {
    ...
    public SearchResponse execute(Search command) {
        ...
        try{
            ...
            while (rs.next()) {
                ...
                tuple.LOK = getURL(rs.getInt("dr_id"),conn);
                list.add(tuple);
            }
            ...
            if (list.size() == 0){
                ...
                for (Tuple t: list){
                    ...
                    if (t.LOK!= null){
                        drNode.addChild(new ResultNode(t.LOK));
                    }
    ...
    private String getURL(Integer id, Connection conn) throws SQLException{
        ResultSet rs = null;
        ...
        try{
            ...
            if (rs.next()){
                ...
                return addLine("URL", "<a href='"+url+"' target='_blank'>"+url+"</a>");
            }
        }finally{
            if (rs != null){
                rs.close();
